                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #f0f0f0;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='white'">
                            <td style="padding: 1rem 1.5rem; color: #6c757d; font-size: 0.9rem;">{{ $petugas->firstItem() + $index }}</td>
                            <td style="padding: 1rem 1.5rem;">
                                <div style="display: flex; align-items: center; gap: 10px;">
                                    <div style="width: 36px; height: 36px; background: #ffe5e5; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; color: #8B0000; font-size: 0.9rem; flex-shrink: 0;">
                            ...
                            <td style="padding: 1rem 1.5rem; text-align: center;">
                                <div style="position: relative; display: inline-block;">
                                    <button onclick="toggleDropdown({{ $p->id }})"
                                        style="background: none; border: none; cursor: pointer; padding: 6px 12px; color: #6c757d; font-size: 1.1rem; line-height: 1;">
                                        ⋮
                                    </button>
                ...
                @if($petugas->hasPages())
                    <div style="padding: 1.5rem; border-top: 1px solid #f0f0f0; display: flex; justify-content: space-between; align-items: center;">
                        <div style="color: #666; font-size: 0.9rem;">
                            {{ $petugas->firstItem() }} - {{ $petugas->lastItem() }} dari {{ $petugas->total() }} petugas
                        </div>

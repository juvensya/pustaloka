...
<div style="max-width:680px;margin:0 auto;">
    ...
    <div style="margin-bottom:2rem;">
        ...
        <h1 style="font-size:1.5rem;font-weight:700;color:#1a0000;margin:0 0 4px;">Tulis Ulasan</h1>
        <p style="font-size:0.85rem;color:#9e4a4a;margin:0;">Bagikan pengalamanmu membaca buku ini</p>
    </div>
                ...
                <div style="margin-bottom:1.75rem;">
                    ...
                    <div style="display:flex;gap:0.5rem;" id="star-container">
                        ...
                        <label style="cursor:pointer;">
                            <input type="radio" name="rating" value="{{ $i }}" style="display:none;" class="star-radio">
                    ...
                    <p id="rating-label" style="font-size:0.78rem;color:#aaa;margin:6px 0 0;">Pilih bintang di atas</p>
                </div>
                ...
                <div style="margin-bottom:1.5rem;">
                    ...
                    <div style="display:flex;gap:0.3rem;padding:0.5rem 0.75rem;background:#f9fafb;border:1px solid #fde8e8;border-bottom:none;border-radius:10px 10px 0 0;flex-wrap:wrap;">
                        ...
                        <button type="button" onclick="fmt('justifyLeft')" title="Rata Kiri"
                            style="width:32px;height:32px;border:1px solid #e5e7eb;background:#fff;border-radius:6px;cursor:pointer;font-size:0.75rem;color:#374151;">
                        ...
                        <button type="button" onclick="fmt('insertUnorderedList')" title="Bullet List"
                            style="width:32px;height:32px;border:1px solid #e5e7eb;background:#fff;border-radius:6px;cursor:pointer;color:#374151;">
...
<script>
    // Sync editor ke hidden input sebelum submit
    function syncEditor() {
